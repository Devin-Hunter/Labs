...
public class Week2BooleansAndConditionalLoops {
...
public static void main(String[] args) {
		...
		} else if ((numberOfCookies % numberOfChildren > 0) && (numberOfCookies % numberOfChildren < 2)) {
			System.out.println("Yes!");
		} else if ((numberOfCookies % numberOfChildren > 2) && (numberOfCookies % numberOfChildren < 5)) {
		...
		switch (loyaltyMemberStatus) {
			case "SILVER":
				System.out.println("Discount is $0.10");
				loyaltyMemberDiscount = 0.10;
				break;
			case "GOLD":
				System.out.println("Discount is $0.15");
				loyaltyMemberDiscount = 0.15;
				break;
			case "PLATINUM":
				System.out.println("Discount is $0.25");
		...
		if (adjustedTotal > 500.00) {
			if (loyaltyMemberStatus == "SILVER") {
				...
				System.out.println("Your loyalty status has been upgraded to GOLD!");
			} else if (loyaltyMemberStatus == "GOLD") {
				loyaltyMemberStatus = "PLATINUM";
				System.out.println("Your loyalty status has been upgraded to PLATINUM!");
			} else if (loyaltyMemberStatus == "PLATINUM") {
				System.out.println("Your loyalty is greatly appreciated!");
			} else {
				System.out.println("You should sign up for our loyalty program to save money!");
			}
		}
		...
		for (int evenOdd = 0; evenOdd <= 100; evenOdd++) {
			if (evenOdd % 2 == 0) {
		...
		for (int divide = 100; divide >= 0; divide--) {
			int remain = divide % 3;
